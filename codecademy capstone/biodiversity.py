...
df = species.groupby(species.conservation_status).scientific_name.nunique().reset_index()
print(df)
...
status_df = species.groupby(species.conservation_status).scientific_name.nunique().reset_index()
print(status_df)
...
category_counts = species.groupby([species.category, species.is_protected]).scientific_name.nunique().reset_index()
...
baseline = 15
minimum_detectable_effect = 100 * (5.0 / 15.0)
significance = 90
sample_size = 520
...
Bryce_obs_per_week = 250
Yellowstone_obs_per_week = 507

weeks_Bryce = sample_size / Bryce_obs_per_week
weeks_Yellowstone = sample_size / Yellowstone_obs_per_week

print('Weeks needed to observe at Bryce National Park: '+ str(weeks_Bryce)+ ' weeks')
print('Weeks needed to observe at Yellowstone National Park: ' + str(weeks_Yellowstone) + ' week')
